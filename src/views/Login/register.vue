<template>
    <div class="register">
      <div class="closeHeader">
        <img @click="closeRegister" src="../../assets/images/back.png" alt="back">
        注 册
      </div>
      ...
      <div class="registerForm">
        ...
        <input class="icon-password" type="password" placeholder="请输入密码">
        <div class="registerbtn icon-loginbtn">注 册</div>
